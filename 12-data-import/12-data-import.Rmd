...
Often, we do data processing in one or more "processing" .Rmd files, we write the output to file, and read the clean data into a different "analysis" .Rmd file.
---
class:inverse

.question[
But what happened to `ses` again?
]
